        ...
        <div class="flex-1 p-3 overflow-y-auto overscroll-contain" @wheel.stop>
          <div v-if="activeTab === 'style'" class="space-y-4">
            ...
            <div class="bg-white/60 border border-gray-100 rounded-xl p-4">
              ...
              <div class="flex items-center justify-between mb-2 py-2 border-t border-gray-100">
                <label class="text-sm font-medium text-gray-700">显示左侧收藏夹边栏</label>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    v-model="store.appConfig.showSidebar"
                    class="sr-only peer"
                  />
                  <div
